...
--
-- Tabelstructuur voor tabel `feed_7`
--

CREATE TABLE IF NOT EXISTS `feed_7` (
...
--
-- Tabelstructuur voor tabel `feed_8`
--

CREATE TABLE IF NOT EXISTS `feed_8` (
  `time` int(10) unsigned DEFAULT NULL,
  `data` float DEFAULT NULL,
  `data2` float DEFAULT NULL,
  KEY `time` (`time`)
...
--
-- Tabelstructuur voor tabel `feed_9`
--

CREATE TABLE IF NOT EXISTS `feed_9` (
  `time` int(10) unsigned DEFAULT NULL,
  `data` float DEFAULT NULL,
  `data2` float DEFAULT NULL,
  KEY `time` (`time`)
